...
impl Checkbox {
    pub fn new(
        ...
        let mut txt = create_label(
            ...
            Bounds::new(
                pos.x + 24.0,
                pos.y,
                pos.x + checkbox_size.x + 24.0,
                pos.y + checkbox_size.y,
            ),
    ...
    pub fn set_hover(&mut self, systems: &mut DrawSetting, is_hover: bool) {
        ...
        if self.is_hover {
            systems
                .gfx
                .set_color(self.window[0], Color::rgba(180, 180, 180, 255));
            systems
                .gfx
                .set_color(self.text, Color::rgba(40, 40, 40, 255));
        } else {
            systems
                .gfx
                .set_color(self.window[0], Color::rgba(180, 180, 180, 0));
            systems
                .gfx
    ...
    pub fn set_select(&mut self, systems: &mut DrawSetting, is_select: bool) {
        ...
        if self.is_select {
            systems
                .gfx
                .set_color(self.window[1], Color::rgba(200, 200, 200, 255));
            systems.gfx.set_border_width(self.window[1], 2.0);
            systems
                .gfx
                .set_border_color(self.window[1], Color::rgba(100, 100, 100, 255));
        } else {
            systems
                .gfx
                .set_color(self.window[1], Color::rgba(100, 100, 100, 255));
